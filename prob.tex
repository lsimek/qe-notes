...
Ovo sluzi samo za template.\section{Introduction}
\subsection{Set structures}
...
\subsubsection{Equivalent definition of \( \lambda \)-system}
...
\subsubsection{Dynkin--Sierpinski \( \pi \)-\( \lambda \) lemma}
...
\subsubsection{Notable exercises}
\emph{Any open set of reals is a countable union of intervals}. See~\cite[ex.\ 1.1.2]{du}. Define
...
\emph{Infinite unions of algebras/\( \sigma \)-algebras}. See~\cite[ex.\ 1.1.4]{du}.
